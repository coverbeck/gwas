...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/gwas/results)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23gwas-4A154B?labelColor=000000&logo=slack)](https://nfcore.slack.com/channels/gwas)
...
**nf-core/gwas** is a bioinformatics best-practice analysis pipeline for A pipeline for genome wide association studies..
...
The nf-core/gwas pipeline comes with documentation about the pipeline [usage](https://nf-co.re/gwas/usage), [parameters](https://nf-co.re/gwas/parameters) and [output](https://nf-co.re/gwas/output).
